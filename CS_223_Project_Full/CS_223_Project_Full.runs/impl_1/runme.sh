...
HD_PWD='C:/Users/oegec/OneDrive/Documents/Ege/Vivado/CS_223_Project_Full/CS_223_Project_Full.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stage_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stage_1.tcl -notrace
