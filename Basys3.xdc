...
# LEDs 
set_property PACKAGE_PIN U16 [get_ports {toShr[0]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {toShr[0]}] 
set_property PACKAGE_PIN E19 [get_ports {toShr[1]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {toShr[1]}] 
set_property PACKAGE_PIN U19 [get_ports {toShr[2]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {toShr[2]}] 
set_property PACKAGE_PIN V19 [get_ports {toShr[3]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {toShr[3]}] 
set_property PACKAGE_PIN W18 [get_ports {toShr[4]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {toShr[4]}] 
set_property PACKAGE_PIN U15 [get_ports {toShr[5]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {toShr[5]}] 
set_property PACKAGE_PIN U14 [get_ports {toShr[6]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {toShr[6]}] 
set_property PACKAGE_PIN V14 [get_ports {toShr[7]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {toShr[7]}] 
#set_property PACKAGE_PIN V13 [get_ports {q[0]}]  	 	 	 	 
# 	set_property IOSTANDARD LVCMOS33 [get_ports {q[0]}] 
#set_property PACKAGE_PIN V3 [get_ports {q[1]}] 	 	 	 	 	 
# 	set_property IOSTANDARD LVCMOS33 [get_ports {q[1]}] 
set_property PACKAGE_PIN W3 [get_ports {ld[0]}]  	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {ld[0]}] 
set_property PACKAGE_PIN U3 [get_ports {ld[1]}]  	 	 	 	 
